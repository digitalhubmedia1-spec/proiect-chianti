...
const AdminEventDetail = () => {
            ...
            <div style={{ 
                ...
                <div style={{ 
                    ...
                    <p style={{ color: '#64748b', marginBottom: '2rem', lineHeight: '1.5' }}>
                        Trebuie să fii autentificat în panoul de administrare pentru a accesa detaliile evenimentului.
                    </p>
                    <button 
    ...
    if (loading || !event) return <div style={{ padding: '2rem', textAlign: 'center' }}>Incarcare...</div>;
